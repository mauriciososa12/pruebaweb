...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_history__ = __webpack_require__(8);
...
"use strict";
/* unused harmony export MiddlewareArray */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_immer__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_redux__ = __webpack_require__(13);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_reselect__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_redux_thunk__ = __webpack_require__(88);
/* unused harmony reexport createNextState */
/* unused harmony reexport createSelector */
/* unused harmony reexport current */
/* unused harmony reexport freeze */
/* unused harmony reexport isDraft */
/* unused harmony reexport original */
...
var createDraftSafeSelector = function () {
    ...
    var selector = __WEBPACK_IMPORTED_MODULE_2_reselect__["a" /* createSelector */].apply(void 0, args);
    var wrappedSelector = function (value) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
        return selector.apply(void 0, __spreadArray([Object(__WEBPACK_IMPORTED_MODULE_0_immer__["d" /* isDraft */])(value) ? Object(__WEBPACK_IMPORTED_MODULE_0_immer__["a" /* current */])(value) : value], rest));
    };
...
var composeWithDevTools = typeof window !== "undefined" && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ : function () {
    ...
    if (typeof arguments[0] === "object")
        return __WEBPACK_IMPORTED_MODULE_1_redux__["c" /* compose */];
    return __WEBPACK_IMPORTED_MODULE_1_redux__["c" /* compose */].apply(null, arguments);
};
...
function getDefaultMiddleware(options) {
    ...
    if (thunk) {
        if (isBoolean(thunk)) {
            middlewareArray.push(__WEBPACK_IMPORTED_MODULE_3_redux_thunk__["a" /* default */]);
        }
        else {
            middlewareArray.push(__WEBPACK_IMPORTED_MODULE_3_redux_thunk__["a" /* default */].withExtraArgument(thunk.extraArgument));
        }
    }
    if (false) {
        if (immutableCheck) {
...
function configureStore(options) {
    ...
    if (typeof reducer === "function") {
        ...
        rootReducer = Object(__WEBPACK_IMPORTED_MODULE_1_redux__["b" /* combineReducers */])(reducer);
    }
    else {
    ...
    var middlewareEnhancer = __WEBPACK_IMPORTED_MODULE_1_redux__["a" /* applyMiddleware */].apply(void 0, finalMiddleware);
    var finalCompose = __WEBPACK_IMPORTED_MODULE_1_redux__["c" /* compose */];
    if (devTools) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_1_redux__["d" /* createStore */])(rootReducer, preloadedState, composedEnhancer);
}
// src/createAction.ts
...
function createReducer(initialState, mapOrBuilderCallback, actionMatchers, defaultCaseReducer) {
    ...
    if (isStateFunction(initialState)) {
        getInitialState = function () { return Object(__WEBPACK_IMPORTED_MODULE_0_immer__["b" /* default */])(initialState(), function () {
        }); };
    }
    else {
        var frozenInitialState_1 = Object(__WEBPACK_IMPORTED_MODULE_0_immer__["b" /* default */])(initialState, function () {
        });
    ...
    function reducer(state, action) {
        ...
        return caseReducers.reduce(function (previousState, caseReducer) {
            if (caseReducer) {
                if (Object(__WEBPACK_IMPORTED_MODULE_0_immer__["d" /* isDraft */])(previousState)) {
                ...
                else if (!Object(__WEBPACK_IMPORTED_MODULE_0_immer__["e" /* isDraftable */])(previousState)) {
                    ...
                    return Object(__WEBPACK_IMPORTED_MODULE_0_immer__["b" /* default */])(previousState, function (draft) {
...
function createSlice(options) {
    ...
    var initialState = typeof options.initialState == "function" ? options.initialState : Object(__WEBPACK_IMPORTED_MODULE_0_immer__["b" /* default */])(options.initialState, function () {
    });
...
function createStateOperator(mutator) {
    return function operation(state, arg) {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_0_immer__["d" /* isDraft */])(state)) {
            runMutator(state);
            return state;
        }
        else {
            return Object(__WEBPACK_IMPORTED_MODULE_0_immer__["b" /* default */])(state, runMutator);
        }
    };
}
...
// src/index.ts
Object(__WEBPACK_IMPORTED_MODULE_0_immer__["c" /* enableES5 */])();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_esm_objectSpread2__ = __webpack_require__(85);
...
var toFormData = __webpack_require__(39);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(113)
  },
...
"use strict";
var AuthCard=function AuthCard(_ref){var children=_ref.children,shadow=_ref.shadow;return React.createElement('div',{className:'auth__card '+(shadow&&'auth__card--shadow')},children);};/* harmony default export */ __webpack_exports__["a"] = (AuthCard);
...
"use strict";
var AuthCardHeader=function AuthCardHeader(_ref){var content=_ref.content,partner=_ref.partner;var title=content.title,message=content.message;return React.createElement('div',{className:'auth__card-header'},React.createElement('h2',{className:'auth__card-title '+(partner&&'auth__card-title--partner')},title),React.createElement('p',{className:'auth__card-message '+(partner&&'auth__card-message--partner')},message));};/* harmony default export */ __webpack_exports__["a"] = (AuthCardHeader);
...
"use strict";
var AuthSection=function AuthSection(_ref){var children=_ref.children;return React.createElement("section",{className:"auth"},React.createElement("div",{className:"auth__container"},children));};/* harmony default export */ __webpack_exports__["a"] = (AuthSection);
...
/* unused harmony reexport NavigationType */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0_history__["e"]; });
/* unused harmony reexport parsePath */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__useReduxContext__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Context__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_useSyncExternalStore__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_is__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__connect_selectorFactory__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__connect_mapDispatchToProps__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__connect_mapStateToProps__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__connect_mergeProps__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__utils_Subscription__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils_useIsomorphicLayoutEffect__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__utils_shallowEqual__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__utils_useSyncExternalStore__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPlainObject__ = __webpack_require__(77);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__batch__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Context__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__useReduxContext__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__defaultMemoize__ = __webpack_require__(87);
/* unused harmony reexport defaultMemoize */
/* unused harmony reexport defaultEqualityCheck */
...
var createSelector = /* #__PURE__ */createSelectorCreator(__WEBPACK_IMPORTED_MODULE_0__defaultMemoize__["a" /* defaultMemoize */]);
...
var parseProtocol = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom_client__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__index_css__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_slick_carousel_slick_slick_css__ = __webpack_require__(129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_slick_carousel_slick_slick_theme_css__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_slick_carousel_slick_slick_theme_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_slick_carousel_slick_slick_theme_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_bootstrap_icons_font_bootstrap_icons_css__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_bootstrap_icons_font_bootstrap_icons_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_bootstrap_icons_font_bootstrap_icons_css__);
...
*/
var aa=__webpack_require__(1),ca=__webpack_require__(56);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_css__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_scss_App_scss__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__styles_scss_App_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__styles_scss_App_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_redux__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__redux_store__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_router_dom__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__layouts_CinemasLayout__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__layouts_CinemasLayout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__layouts_CinemasLayout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_cinemas_CinemasHome__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_cinemas_CinemasHome___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__pages_cinemas_CinemasHome__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__layouts_AuthLayout__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__layouts_AuthLayout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__layouts_AuthLayout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_auth_AuthRegister__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_auth_AuthLogin__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_auth_AuthRecoverPassword__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_cinemas_CinemasCandyStore__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_cinemas_CinemasCandyStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__pages_cinemas_CinemasCandyStore__);
function App(){return React.createElement(__WEBPACK_IMPORTED_MODULE_2_react_redux__["a" /* Provider */],{store:__WEBPACK_IMPORTED_MODULE_3__redux_store__["a" /* default */]},React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["d" /* Routes */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'/',element:React.createElement(__WEBPACK_IMPORTED_MODULE_5__layouts_CinemasLayout__["default"],null)},React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'dulceria',element:React.createElement(__WEBPACK_IMPORTED_MODULE_11__pages_cinemas_CinemasCandyStore__["default"],null)}),React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{index:true,element:React.createElement(__WEBPACK_IMPORTED_MODULE_6__pages_cinemas_CinemasHome__["default"],null)}),React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'*',element:React.createElement('h1',null,'404')})),React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'/autenticacion',element:React.createElement(__WEBPACK_IMPORTED_MODULE_7__layouts_AuthLayout__["default"],null)},React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'registro',element:React.createElement(__WEBPACK_IMPORTED_MODULE_8__pages_auth_AuthRegister__["a" /* default */],null)}),React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'login',element:React.createElement(__WEBPACK_IMPORTED_MODULE_9__pages_auth_AuthLogin__["a" /* default */],null)}),React.createElement(__WEBPACK_IMPORTED_MODULE_4_react_router_dom__["c" /* Route */],{path:'recuperar-contrasena',element:React.createElement(__WEBPACK_IMPORTED_MODULE_10__pages_auth_AuthRecoverPassword__["a" /* default */],null)}))));};/* harmony default export */ __webpack_exports__["a"] = (App);

/***/ }),
/* 61 */
/***/ (function(module, exports) {

throw new Error("Module build failed: ModuleBuildError: Module build failed: BrowserslistError: Unknown browser query `dead`\n    at error (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\node_modules\\browserslist\\index.js:37:11)\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\node_modules\\browserslist\\index.js:222:9\n    at Array.forEach (<anonymous>)\n    at browserslist (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\node_modules\\browserslist\\index.js:196:13)\n    at cleanBrowsersList (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\dist\\utils.js:56:59)\n    at setBrowserScope (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\dist\\index.js:29:43)\n    at Object.<anonymous> (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\caniuse-api\\dist\\index.js:91:1)\n    at Module._compile (node:internal/modules/cjs/loader:1275:14)\n    at Module._extensions..js (node:internal/modules/cjs/loader:1329:10)\n    at Module.load (node:internal/modules/cjs/loader:1133:32)\n    at Module._load (node:internal/modules/cjs/loader:972:12)\n    at Module.require (node:internal/modules/cjs/loader:1157:19)\n    at require (node:internal/modules/helpers:119:18)\n    at Object.<anonymous> (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\postcss-merge-rules\\dist\\lib\\ensureCompatibility.js:7:19)\n    at Module._compile (node:internal/modules/cjs/loader:1275:14)\n    at Module._extensions..js (node:internal/modules/cjs/loader:1329:10)\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\webpack\\lib\\NormalModule.js:195:19\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:367:11\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:233:18\n    at runSyncOrAsync (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:143:3)\n    at iterateNormalLoaders (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:232:2)\n    at iterateNormalLoaders (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:221:10)\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:236:3\n    at context.callback (C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\loader-runner\\lib\\LoaderRunner.js:111:13)\n    at C:\\Users\\MAuricio\\Desktop\\cineverse-develop\\node_modules\\postcss-loader\\lib\\index.js:180:9\n    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)");

/***/ }),
/* 62 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/media/App.586323de.scss";
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_use_sync_external_store_shim__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_use_sync_external_store_shim_with_selector__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_reactBatchedUpdates__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_batch__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hooks_useSelector__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_connect__ = __webpack_require__(27);
/* unused harmony reexport batch */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__exports__ = __webpack_require__(80);
...
Object(__WEBPACK_IMPORTED_MODULE_5__components_connect__["a" /* initializeConnect */])(__WEBPACK_IMPORTED_MODULE_0_use_sync_external_store_shim__["useSyncExternalStore"]); // Enable batched updates in our subscriptions for use
 ...
 * LICENSE file in the root directory of this source tree.
 */
var h=__webpack_require__(1),n=__webpack_require__(22);function p(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q="function"===typeof Object.is?Object.is:p,r=n.useSyncExternalStore,t=h.useRef,u=h.useEffect,v=h.useMemo,w=h.useDebugValue;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__verifySubselectors__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_bindActionCreators__ = __webpack_require__(76);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_esm_extends__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_verifyPlainObject__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__invalidArgFactory__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connect__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Context__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__hooks_useDispatch__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hooks_useSelector__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__hooks_useStore__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils_shallowEqual__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__types__ = __webpack_require__(83);
/* unused harmony namespace reexport */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_Subscription__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_useIsomorphicLayoutEffect__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__useStore__ = __webpack_require__(34);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__reduxjs_toolkit__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slices_auth_slices__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slices_cinemas_slices__ = __webpack_require__(90);
var store=Object(__WEBPACK_IMPORTED_MODULE_0__reduxjs_toolkit__["a" /* configureStore */])({reducer:{cinemasStore:__WEBPACK_IMPORTED_MODULE_2__slices_cinemas_slices__["a" /* default */],authStore:__WEBPACK_IMPORTED_MODULE_1__slices_auth_slices__["a" /* default */]}});/* harmony default export */ __webpack_exports__["a"] = (store);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__defineProperty_js__ = __webpack_require__(86);
...
"use strict";
/* unused harmony export defaultEqualityCheck */
/* unused harmony export createCacheKeyComparator */
/* harmony export (immutable) */ __webpack_exports__["a"] = defaultMemoize;
...
"use strict";
/* unused harmony export fetchAuthRegisterError */
/* unused harmony export fetchAuthRegisterRequest */
/* unused harmony export fetchAuthRegisterSuccess */
/* unused harmony export fetchAuthLoginError */
/* unused harmony export fetchAuthLoginRequest */
/* unused harmony export fetchAuthLoginSuccess */
/* unused harmony export logOutAuth */
/* unused harmony export fetchAuthRecoverPasswordError */
/* unused harmony export fetchAuthRecoverPasswordRequest */
/* unused harmony export fetchAuthRecoverPasswordSuccess */
/* unused harmony export fetchAuthSignInWithGoogleError */
/* unused harmony export fetchAuthSignInWithGoogleRequest */
/* unused harmony export fetchAuthSignInWithGoogleSuccess */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__reduxjs_toolkit__ = __webpack_require__(12);
var initialState={loading:false,error:{},user:{}};var authSlices=Object(__WEBPACK_IMPORTED_MODULE_0__reduxjs_toolkit__["b" /* createSlice */])({name:'auth',initialState:initialState,reducers:{fetchAuthRegisterRequest:function fetchAuthRegisterRequest(state,action){return Object.assign({},state,{loading:action.payload});},fetchAuthRegisterSuccess:function fetchAuthRegisterSuccess(state,action){return Object.assign({},state,{loading:false,error:{},user:action.payload});},fetchAuthRegisterError:function fetchAuthRegisterError(state,action){return Object.assign({},state,{loading:false,error:action.payload,user:{}});},fetchAuthLoginRequest:function fetchAuthLoginRequest(state,action){return Object.assign({},state,{loading:action.payload});},fetchAuthLoginSuccess:function fetchAuthLoginSuccess(state,action){return Object.assign({},state,{loading:false,error:{},user:action.payload});},fetchAuthLoginError:function fetchAuthLoginError(state,action){return Object.assign({},state,{loading:false,error:action.payload,user:{}});},logOutAuth:function logOutAuth(state){return Object.assign({},state,{loading:false,error:{},user:{}});},fetchAuthRecoverPasswordRequest:function fetchAuthRecoverPasswordRequest(state,action){return Object.assign({},state,{loading:action.payload});},fetchAuthRecoverPasswordSuccess:function fetchAuthRecoverPasswordSuccess(state){return Object.assign({},state,{loading:false,error:{},user:{}});},fetchAuthRecoverPasswordError:function fetchAuthRecoverPasswordError(state,action){return Object.assign({},state,{loading:false,error:action.payload,user:{}});},fetchAuthSignInWithGoogleRequest:function fetchAuthSignInWithGoogleRequest(state,action){return Object.assign({},state,{loading:action.payload});},fetchAuthSignInWithGoogleSuccess:function fetchAuthSignInWithGoogleSuccess(state,action){return Object.assign({},state,{loading:false,error:{},user:action.payload});},fetchAuthSignInWithGoogleError:function fetchAuthSignInWithGoogleError(state,action){return Object.assign({},state,{loading:false,error:action.payload,user:{}});}}});var _authSlices$actions=authSlices.actions;var fetchAuthRegisterError=_authSlices$actions.fetchAuthRegisterError,fetchAuthRegisterRequest=_authSlices$actions.fetchAuthRegisterRequest,fetchAuthRegisterSuccess=_authSlices$actions.fetchAuthRegisterSuccess,fetchAuthLoginError=_authSlices$actions.fetchAuthLoginError,fetchAuthLoginRequest=_authSlices$actions.fetchAuthLoginRequest,fetchAuthLoginSuccess=_authSlices$actions.fetchAuthLoginSuccess,logOutAuth=_authSlices$actions.logOutAuth,fetchAuthRecoverPasswordError=_authSlices$actions.fetchAuthRecoverPasswordError,fetchAuthRecoverPasswordRequest=_authSlices$actions.fetchAuthRecoverPasswordRequest,fetchAuthRecoverPasswordSuccess=_authSlices$actions.fetchAuthRecoverPasswordSuccess,fetchAuthSignInWithGoogleError=_authSlices$actions.fetchAuthSignInWithGoogleError,fetchAuthSignInWithGoogleRequest=_authSlices$actions.fetchAuthSignInWithGoogleRequest,fetchAuthSignInWithGoogleSuccess=_authSlices$actions.fetchAuthSignInWithGoogleSuccess;/* harmony default export */ __webpack_exports__["a"] = (authSlices.reducer);
...
"use strict";
/* unused harmony export fetchReadPremieres */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reduxjs_toolkit__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__configs_axiosInstance__ = __webpack_require__(94);
var _this=this;function _asyncToGenerator(fn){return function(){var gen=fn.apply(this,arguments);return new Promise(function(resolve,reject){function step(key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{return Promise.resolve(value).then(function(value){step("next",value);},function(err){step("throw",err);});}}return step("next");});};}var initialState={loading:false,error:{},premieres:[]};var cinemasSlices=Object(__WEBPACK_IMPORTED_MODULE_1__reduxjs_toolkit__["b" /* createSlice */])({name:'cinemas',initialState:initialState,reducers:{fetchReadPremieresRequest:function fetchReadPremieresRequest(state,action){return Object.assign({},state,{loading:action.payload});},fetchReadPremieresSuccess:function fetchReadPremieresSuccess(state,action){return Object.assign({},state,{loading:false,error:{},premieres:action.payload});},fetchReadPremieresError:function fetchReadPremieresError(state,action){return Object.assign({},state,{loading:false,error:action.payload,premieres:[]});}}});var _cinemasSlices$action=cinemasSlices.actions,fetchReadPremieresError=_cinemasSlices$action.fetchReadPremieresError,fetchReadPremieresRequest=_cinemasSlices$action.fetchReadPremieresRequest,fetchReadPremieresSuccess=_cinemasSlices$action.fetchReadPremieresSuccess;var fetchReadPremieres=function fetchReadPremieres(){return function(){var _ref=_asyncToGenerator(/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(dispatch){var options,_ref2,data,premieres;return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:dispatch(fetchReadPremieresRequest(true));_context.prev=1;options={method:'GET',url:'/discover/movie'};_context.next=5;return Object(__WEBPACK_IMPORTED_MODULE_2__configs_axiosInstance__["a" /* default */])(options);case 5:_ref2=_context.sent;data=_ref2.data;// dispatch(fetchReadPremieresSuccess(data.premieres));
premieres=data.results.splice(0,6);dispatch(fetchReadPremieresSuccess(premieres));_context.next=14;break;case 11:_context.prev=11;_context.t0=_context["catch"](1);dispatch(fetchReadPremieresError(_context.t0));case 14:case"end":return _context.stop();}}},_callee,_this,[[1,11]]);}));return function(_x){return _ref.apply(this,arguments);};}();};/* harmony default export */ __webpack_exports__["a"] = (cinemasSlices.reducer);
...
var axiosInstance=__WEBPACK_IMPORTED_MODULE_0_axios___default.a.create({baseURL:Object({"NODE_ENV":"production","PUBLIC_URL":""}).REACT_APP_CINEVERSE_API_URL,headers:{'Authorization':'Bearer '+Object({"NODE_ENV":"production","PUBLIC_URL":""}).REACT_APP_CINEVERSE_API_TOKEN,'Content-Type':'application/json;charset=utf-8'}});/* harmony default export */ __webpack_exports__["a"] = (axiosInstance);
...
axios.CanceledError = __webpack_require__(7);
...
axios.toFormData = __webpack_require__(39);
...
var mergeConfig = __webpack_require__(43);
var buildFullPath = __webpack_require__(41);
var validator = __webpack_require__(114);
...
throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/layouts/CinemasLayout.jsx: Unexpected token (23:5)\n\n\u001b[0m \u001b[90m 21 | \u001b[39m\n \u001b[90m 22 | \u001b[39m  \u001b[36mreturn\u001b[39m (\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 23 | \u001b[39m    \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m    | \u001b[39m     \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 24 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mHeader\u001b[39m\n \u001b[90m 25 | \u001b[39m        applicationName\u001b[33m=\u001b[39m{applicationName}\n \u001b[90m 26 | \u001b[39m      \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n");

/***/ }),
/* 119 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/pages/cinemas/CinemasHome.jsx: Unexpected token (21:5)\n\n\u001b[0m \u001b[90m 19 | \u001b[39m\n \u001b[90m 20 | \u001b[39m  \u001b[36mreturn\u001b[39m (\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 21 | \u001b[39m    \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m    | \u001b[39m     \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 22 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mCinemasSlider\u001b[39m premieres\u001b[33m=\u001b[39m{premieres} \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 23 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mCinemasGallery\u001b[39m premieres\u001b[33m=\u001b[39m{premieres} \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 24 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mCinemasPartner\u001b[39m \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n");

/***/ }),
/* 120 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/layouts/AuthLayout.jsx: Unexpected token (24:5)\n\n\u001b[0m \u001b[90m 22 | \u001b[39m\n \u001b[90m 23 | \u001b[39m  \u001b[36mreturn\u001b[39m (\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 24 | \u001b[39m    \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m    | \u001b[39m     \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 25 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mAuthHeader\u001b[39m\n \u001b[90m 26 | \u001b[39m        applicationName\u001b[33m=\u001b[39m{applicationName}\n \u001b[90m 27 | \u001b[39m      \u001b[33m/\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRegisterForm__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRegisterForm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRegisterForm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__ = __webpack_require__(17);
var AuthRegister=function AuthRegister(){Object(__WEBPACK_IMPORTED_MODULE_0_react__["useEffect"])(function(){document.title='Únete';window.scrollTo(0,0);},[]);return React.createElement(__WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],{shadow:true},React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'Únete',message:'Completa tus datos y accede a nuestro universo de beneficios'}}),React.createElement(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRegisterForm__["default"],null)),React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'¿Ya eres socio?',message:'Iniciando sesión en nuestro programa Socio podrás acumular puntos en cada visita que realices y gozar de grandes beneficios.'},partner:true}),React.createElement('div',{className:'auth__button-container'},React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/autenticacion/login',className:'auth__primary-button'},React.createElement('i',{className:'bi bi-person'}),' Iniciar sesi\xF3n'))));};/* harmony default export */ __webpack_exports__["a"] = (AuthRegister);

/***/ }),
/* 122 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/components/auth/AuthRegisterForm.jsx: Unexpected token (60:110)\n\n\u001b[0m \u001b[90m 58 | \u001b[39m                disabled\u001b[33m=\u001b[39m{isSubmitting}\n \u001b[90m 59 | \u001b[39m              \u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 60 | \u001b[39m                {isSubmitting \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mdiv\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"animate-spin\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-arrow-repeat\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mi\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mdiv\u001b[39m\u001b[33m>\u001b[39m \u001b[33m:\u001b[39m \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-person-circle\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[35m/i> Unirme</\u001b[39m\u001b[33m>\u001b[39m}\n \u001b[90m    | \u001b[39m                                                                                                              \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 61 | \u001b[39m              \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mbutton\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 62 | \u001b[39m            \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mdiv\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 63 | \u001b[39m          \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mForm\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthLoginForm__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthLoginForm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthLoginForm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__ = __webpack_require__(17);
var AuthLogin=function AuthLogin(){Object(__WEBPACK_IMPORTED_MODULE_0_react__["useEffect"])(function(){document.title='Iniciar sesión';window.scrollTo(0,0);},[]);return React.createElement(__WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],{shadow:true},React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'Iniciar sesión',message:'Ingresa a tu cuenta para disfrutar de tus beneficios, acumular puntos y vivir al máximo la experiencia.'}}),React.createElement(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthLoginForm__["default"],null)),React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'¿No eres socio?',message:'Registrándote en nuestro programa Socio  podrás acumular puntos en cada visita que realices y gozar de grandes beneficios.'},partner:true}),React.createElement('div',{className:'auth__button-container'},React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/autenticacion/registro',className:'auth__secondary-button'},React.createElement('i',{className:'bi bi-person-circle'}),' \xDAnete'),React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/dulceria',className:'auth__primary-button auth__primary-button--outline'},'Seguir como invitado'))));};/* harmony default export */ __webpack_exports__["a"] = (AuthLogin);

/***/ }),
/* 124 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/components/auth/AuthLoginForm.jsx: Unexpected token (104:110)\n\n\u001b[0m \u001b[90m 102 | \u001b[39m                disabled\u001b[33m=\u001b[39m{isSubmitting}\n \u001b[90m 103 | \u001b[39m              \u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 104 | \u001b[39m                {isSubmitting \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mdiv\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"animate-spin\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-arrow-repeat\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mi\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mdiv\u001b[39m\u001b[33m>\u001b[39m \u001b[33m:\u001b[39m \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-person\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[35m/i> Ingresar</\u001b[39m\u001b[33m>\u001b[39m}\n \u001b[90m     | \u001b[39m                                                                                                              \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 105 | \u001b[39m              \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mbutton\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 106 | \u001b[39m              \u001b[33m<\u001b[39m\u001b[33mspan\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"auth__text\"\u001b[39m\u001b[33m>\u001b[39mo\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mspan\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 107 | \u001b[39m              \u001b[33m<\u001b[39m\u001b[33mbutton\u001b[39m\u001b[0m\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRecoverPasswordForm__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRecoverPasswordForm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRecoverPasswordForm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__ = __webpack_require__(17);
var AuthRecoverPassword=function AuthRecoverPassword(){Object(__WEBPACK_IMPORTED_MODULE_0_react__["useEffect"])(function(){document.title='¿Olvidaste tu contraseña?';window.scrollTo(0,0);},[]);return React.createElement(__WEBPACK_IMPORTED_MODULE_5__components_auth_AuthSection__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],{shadow:true},React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'¿Olvidaste tu contraseña?',message:'Ingresa tu dirección de email registrada y te enviaremos un correo para que puedas crear una nueva contraseña.'}}),React.createElement(__WEBPACK_IMPORTED_MODULE_4__components_auth_AuthRecoverPasswordForm__["default"],null)),React.createElement(__WEBPACK_IMPORTED_MODULE_2__components_auth_AuthCard__["a" /* default */],null,React.createElement(__WEBPACK_IMPORTED_MODULE_3__components_auth_AuthCardHeader__["a" /* default */],{content:{title:'¿Algo anda mal?',message:'¿Ya tienes cuenta? o ¿No tienes cuenta?'},partner:true}),React.createElement('div',{className:'auth__button-container'},React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/autenticacion/login',className:'auth__primary-button'},React.createElement('i',{className:'bi bi-person'}),' Iniciar sesi\xF3n'),React.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/autenticacion/registro',className:'auth__secondary-button'},React.createElement('i',{className:'bi bi-person-circle'}),' \xDAnete'))));};/* harmony default export */ __webpack_exports__["a"] = (AuthRecoverPassword);

/***/ }),
/* 126 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/components/auth/AuthRecoverPasswordForm.jsx: Unexpected token (74:110)\n\n\u001b[0m \u001b[90m 72 | \u001b[39m                disabled\u001b[33m=\u001b[39m{isSubmitting}\n \u001b[90m 73 | \u001b[39m              \u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 74 | \u001b[39m                {isSubmitting \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mdiv\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"animate-spin\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-arrow-repeat\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mi\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mdiv\u001b[39m\u001b[33m>\u001b[39m \u001b[33m:\u001b[39m \u001b[33m<\u001b[39m\u001b[33m>\u001b[39m\u001b[33mRecuperar\u001b[39m \u001b[33m<\u001b[39m\u001b[33mi\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"bi bi-chevron-right\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[35m/i></\u001b[39m\u001b[33m>\u001b[39m}\n \u001b[90m    | \u001b[39m                                                                                                              \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 75 | \u001b[39m              \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mbutton\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 76 | \u001b[39m            \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mdiv\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 77 | \u001b[39m          \u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mForm\u001b[39m\u001b[33m>\u001b[39m\u001b[0m\n");

/***/ }),
/* 127 */
/***/ (function(module, exports) {

throw new Error("Module build failed: SyntaxError: C:/Users/MAuricio/Desktop/cineverse-develop/src/pages/cinemas/CinemasCandyStore.jsx: Unexpected token, expected , (72:70)\n\n\u001b[0m \u001b[90m 70 | \u001b[39m    \u001b[33m<\u001b[39m\u001b[33msection\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"section\"\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 71 | \u001b[39m      \u001b[33m<\u001b[39m\u001b[33mdiv\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"section__container\"\u001b[39m\u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 72 | \u001b[39m        \u001b[33m<\u001b[39m\u001b[33mh1\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"section__title\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33mBienvenido\u001b[39m {(user\u001b[33m.\u001b[39mdisplayName \u001b[33m?\u001b[39m\u001b[33m?\u001b[39m user\u001b[33m.\u001b[39memail) \u001b[33m?\u001b[39m\u001b[33m?\u001b[39m \u001b[32m'Invitado'\u001b[39m} a la \u001b[33mDulcería\u001b[39m de \u001b[33mCineverse\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m    | \u001b[39m                                                                      \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 73 | \u001b[39m        {\n \u001b[90m 74 | \u001b[39m          user\u001b[33m.\u001b[39memail \u001b[33m&&\u001b[39m\n \u001b[90m 75 | \u001b[39m          \u001b[33m<\u001b[39m\u001b[33mbutton\u001b[39m\u001b[0m\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.a0437836.js.map